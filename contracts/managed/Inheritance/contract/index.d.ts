...
export type ImpureCircuits<PS> = {
  setup(context: __compactRuntime.CircuitContext<PS>,
        ...
        hiddenBeneficiaryHash_0: Uint8Array,
  ...
  claim(context: __compactRuntime.CircuitContext<PS>,
        ...
        beneficiaryAddr_0: Uint8Array,
        secretPasscode_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
}
...
export type Ledger = {
  ...
  readonly finalBeneficiary: Uint8Array;
  readonly beneficiaryCommitment: Uint8Array;
}
